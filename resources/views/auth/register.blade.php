<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="ph_number" class="block mt-1 w-full" type="text" name="ph_number" :value="old('ph_number')" required autocomplete="tel" />
            <x-input-error :messages="$errors->get('ph_number')" class="mt-2" />
        </div>
