...
<body class="bg-admin-gray font-sans antialiased">
    ...
    <div id="sidebarOverlay" class="fixed inset-0 bg-black bg-opacity-50 z-20 hidden sidebar-overlay" onclick="closeSidebar()"></div>
    
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar - Desktop: fixed, Mobile: absolute -->
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-72 bg-admin-blue text-white shadow-xl transform -translate-x-full md:relative md:translate-x-0 sidebar-transition flex flex-col">
            ...
            <nav class="flex-1 py-6 overflow-y-auto sidebar-scroll">
                <ul class="space-y-2 px-4">
                    ...
                    <li>
                        <div class="flex items-center justify-between px-4 py-3 rounded-lg cursor-pointer hover:bg-blue-800 text-blue-100 transition-all duration-200" onclick="toggleSubmenu('productsSubmenu')">
                            <div class="flex items-center space-x-3">
                    ...
                    <!-- Product Types -->
                    <li>
                        <div class="flex items-center justify-between px-4 py-3 rounded-lg cursor-pointer hover:bg-blue-800 text-blue-100 transition-all duration-200" onclick="toggleSubmenu('typesSubmenu')">
                            <div class="flex items-center space-x-3">
                    ...
                    <!-- Brands -->
                    <li>
                        <div class="flex items-center justify-between px-4 py-3 rounded-lg cursor-pointer hover:bg-blue-800 text-blue-100 transition-all duration-200" onclick="toggleSubmenu('brandsSubmenu')">
                            <div class="flex items-center space-x-3">
                    ...
                    <!-- Deliveries -->
                    <li>
                        <div class="flex items-center justify-between px-4 py-3 rounded-lg cursor-pointer hover:bg-blue-800 text-blue-100 transition-all duration-200" onclick="toggleSubmenu('deliveriesSubmenu')">
                            <div class="flex items-center space-x-3">
                    ...
                    <!-- Reports -->
                    <li>
                        <div class="flex items-center justify-between px-4 py-3 rounded-lg cursor-pointer hover:bg-blue-800 text-blue-100 transition-all duration-200" onclick="toggleSubmenu('reportsSubmenu')">
                            <div class="flex items-center space-x-3">
                    ...
                    <li class="pt-4 mt-2 border-t border-blue-800">
                        <div class="flex items-center justify-between px-4 py-3 rounded-lg cursor-pointer hover:bg-blue-800 text-blue-100 transition-all duration-200" onclick="toggleSubmenu('settingsSubmenu')">
                            <div class="flex items-center space-x-3">
            ...
            <div class="p-4 border-t border-blue-800">
                <div class="flex items-center space-x-3">
                    <div class="w-10 h-10 rounded-full bg-admin-light-blue flex items-center justify-center flex-shrink-0">
        ...
        <div class="flex-1 w-full md:ml-0 overflow-y-auto">
            ...
            <header class="bg-admin-white shadow-sm sticky top-0 z-20">
                <div class="flex justify-between items-center px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
                    <!-- Mobile Menu Button -->
                    <button onclick="openSidebar()" class="md:hidden text-admin-blue hover:text-admin-light-blue focus:outline-none">
                    ...
                    <div class="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <!-- Profile Dropdown -->
                        <div class="relative">
                            <div id="profileDropdownBtn" class="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 rounded-lg px-2 py-1 transition-colors">
                                <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-admin-light-blue flex items-center justify-center">
                                    <i class="fas fa-user text-white text-sm sm:text-base"></i>
                                </div>
                                <span class="text-sm text-gray-700 hidden sm:inline">{{ Auth::user()->name ?? 'Admin' }}</span>
                                <i class="fas fa-chevron-down text-gray-500 text-xs sm:text-sm hidden sm:block transition-transform duration-200" id="dropdownArrow"></i>
                            </div>
                            
                            <!-- Dropdown Menu -->
                            <div id="profileDropdown" class="dropdown-menu absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-100 overflow-hidden z-50">
                                ...
                                <div class="py-2">
                                    <a href="#" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-admin-blue transition-colors">
